...
<body>
    ...
    ?>
    <h1 class="text-center">Lista de Administrador Activos</h1>
    <div class="container">
        ...
        <tbody>
            <?php foreach($datos as $item) { ?>
                <tr>
                    ...
                    <td>
                        <button class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#ModalAdministrador<?php echo $item["id"]; ?>">Ver Mas</button>
                    </td>
                    <td>
